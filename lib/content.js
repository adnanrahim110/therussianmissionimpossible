export const siteMeta = {
  ...
  tagline: "Operation Stream 3.0",
  publisher: "Publisher: CGG International W.L.L.",
...
export const mythPoll = {
  ...
  background: {
    title: "Operation's Background",
    body: [
      "In August 2024, Ukrainian forces entered the Kursk border region, including the city of Sudzha. Residents were forced to evacuate under shelling, while others remained trapped in occupied territory. Communication lines were destroyed, and access to food, electricity, and medical support became limited.",
      "The situation created urgency for a strategic response. Operation Stream 3.0 emerged as a mission designed to reach and liberate the occupied area, whilst minimizing civilian casualties."
    ]
  },
  sections: [
    {
...
export const briefingVideo = {
  ...
  status: "pending",
  summary:
    "A short intelligence-briefing reel is in production, designed to extend the narrative beyond static pages.",
  beats: [
    "Redacted documents",
    "Operation maps",
    "Schematic diagrams",
  ...
  placeholderNote:
    "Media assets are still pending. Until delivery, the interface frames this area as an incoming reel rather than an inactive player.",
};
