...
const heroSlides = [
  {
    image: "/imgs/placeholders/mission-slide-01.svg",
    alt: "Mission placeholder slide 01",
  },
  {
    image: "/imgs/placeholders/mission-slide-02.svg",
    alt: "Mission placeholder slide 02",
  },
  {
    image: "/imgs/placeholders/mission-slide-03.svg",
      ...
      <Container className="relative z-10">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.98fr)] lg:gap-14">
          <div>
            ...
            <h1 className="mt-4 font-heading text-[clamp(2.5rem,4.5vw+0.3rem,3.7rem)] leading-none text-stone-50">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Button href="/book" size="lg" className="min-w-55">
                Access Full Story
              </Button>
              <Button
            ...
            >
              {heroSlides.map((slide) => (
                <SwiperSlide key={slide.image}>
                  <div className="relative h-100 sm:h-120 lg:h-136">
                    <Image
                      src={slide.image}
                      alt={slide.alt}
                      fill
