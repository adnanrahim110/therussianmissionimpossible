export function AccentBackdrop() {
  return (
    ...
    >
      ...
      <div className="absolute right-[8vw] top-[12vh] size-[14rem] rounded-full bg-green-500/12 blur-[80px]" />
      <div className="absolute left-[-4rem] top-[42vh] size-[18rem] rounded-full bg-rose-700/10 blur-[90px]" />
      <div className="absolute right-[-3rem] top-[55vh] size-[16rem] rounded-full bg-green-500/12 blur-[80px]" />
      <div className="absolute left-[28vw] top-[78vh] size-[14rem] rounded-full bg-rose-600/12 blur-[80px]" />
      <div className="absolute right-[18vw] top-[92vh] size-[20rem] rounded-full bg-green-500/12 blur-[100px]" />
