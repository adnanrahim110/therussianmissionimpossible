...
export default function BookPage() {
  return (
    <ArchivePageShell
      ...
      actions={[
        { label: purchaseCtas.instructions.label, href: purchaseCtas.instructions.href },
    ...
    >
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.7fr)]">
        <ArchivePanel eyebrow="Book Overview" iconKey="book" title="Documentary narrative" summary={BOOK.synopsis}>
